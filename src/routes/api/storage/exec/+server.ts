 ...
 *
 * The SQL on this endpoint comes from our own repo code only (see
 * `src/lib/storage/repos/*`). User-supplied SQL goes through the separate
 * `/api/db/*` path which targets the customer's database, not `meta.db`.
 */
